...
write.table(p1, file = "C:\\Users\\Sarah\\Desktop\\Text Mining\\Text-Mining\\cg-air_stop_words.csv", sep = ",", row.names = F, na = "NA")
write.table(p1, file = "C:\\Users\\Sarah\\Desktop\\Text Mining\\Text-Mining\\cg-air_tdm.csv", sep = ",", row.names = F, na = "NA")
write.table(p1, file = "C:\\Users\\Sarah\\Desktop\\Text Mining\\Text-Mining\\cg-air_tdm.df.csv", sep = ",", row.names = F, na = "NA")
write.table(p1, file = "C:\\Users\\Sarah\\Desktop\\Text Mining\\Text-Mining\\cg-air_matrix.csv", sep = ",", row.names = F, na = "NA")
write.table(p1, file = "C:\\Users\\Sarah\\Desktop\\Text Mining\\Text-Mining\\cg-air_tidy_abstract.csv", sep = ",", row.names = F, na = "NA")
write.table(p1, file = "C:\\Users\\Sarah\\Desktop\\Text Mining\\Text-Mining\\cg-air_tidy_abstract_count.csv", sep = ",", row.names = F, na = "NA")
